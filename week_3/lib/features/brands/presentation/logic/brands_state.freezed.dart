...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BrandsState<T>);
}
...
/// @nodoc
class $BrandsStateCopyWith<T,$Res>  {
$BrandsStateCopyWith(BrandsState<T> _, $Res Function(BrandsState<T>) __);
}


/// Adds pattern-matching-related methods to [BrandsState].
extension BrandsStatePatterns<T> on BrandsState<T> {
...
class Idle<T> implements BrandsState<T> {
  const Idle();
...
class Loading<T> implements BrandsState<T> {
  const Loading();
...
class Success<T> implements BrandsState<T> {
...
@override
String toString() {
  return 'BrandsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $BrandsStateCopyWith<T, $Res> {
...
class Error<T> implements BrandsState<T> {
...
@override
String toString() {
  return 'BrandsState<$T>.error(networkExceptions: $networkExceptions)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $BrandsStateCopyWith<T, $Res> {
