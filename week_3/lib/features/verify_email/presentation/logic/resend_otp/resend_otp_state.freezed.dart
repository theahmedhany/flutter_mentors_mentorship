...
class Idle<T> implements ResendOtpState<T> {
  const Idle();
...
class Error<T> implements ResendOtpState<T> {
...
@override
String toString() {
  return 'ResendOtpState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ResendOtpStateCopyWith<T, $Res> {
