...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserProfileState<T>);
}
...
/// @nodoc
class $UserProfileStateCopyWith<T,$Res>  {
$UserProfileStateCopyWith(UserProfileState<T> _, $Res Function(UserProfileState<T>) __);
}


/// Adds pattern-matching-related methods to [UserProfileState].
extension UserProfileStatePatterns<T> on UserProfileState<T> {
...
class Idle<T> implements UserProfileState<T> {
  const Idle();
...
@override
String toString() {
  return 'UserProfileState<$T>.idle()';
}
...
class Loading<T> implements UserProfileState<T> {
  const Loading();
...
class Success<T> implements UserProfileState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $UserProfileStateCopyWith<T, $Res> {
...
class Error<T> implements UserProfileState<T> {
...
@override
String toString() {
  return 'UserProfileState<$T>.error(networkExceptions: $networkExceptions)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $UserProfileStateCopyWith<T, $Res> {
