...
class Idle<T> implements FavoriteState<T> {
  const Idle();
...
class Loading<T> implements FavoriteState<T> {
  const Loading();
...
class Success<T> implements FavoriteState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $FavoriteStateCopyWith<T, $Res> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $FavoriteStateCopyWith<T, $Res> {
