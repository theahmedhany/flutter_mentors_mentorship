...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductDetailsState<T>);
}
...
/// @nodoc
class $ProductDetailsStateCopyWith<T,$Res>  {
$ProductDetailsStateCopyWith(ProductDetailsState<T> _, $Res Function(ProductDetailsState<T>) __);
}


/// Adds pattern-matching-related methods to [ProductDetailsState].
extension ProductDetailsStatePatterns<T> on ProductDetailsState<T> {
...
class Idle<T> implements ProductDetailsState<T> {
  const Idle();
...
@override
String toString() {
  return 'ProductDetailsState<$T>.idle()';
}
...
class Loading<T> implements ProductDetailsState<T> {
  const Loading();
...
class Success<T> implements ProductDetailsState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ProductDetailsStateCopyWith<T, $Res> {
...
class Error<T> implements ProductDetailsState<T> {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ProductDetailsStateCopyWith<T, $Res> {
